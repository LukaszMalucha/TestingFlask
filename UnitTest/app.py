...
MENU_PROMPT = 'Enter "c" to create a blog, "l" to list blogs, "r" to read one, "p" to create a a post, or "q" to quit:'
POST_TEMPLATE = '''
    --- {} ---
...
def ask_create_post():
    blog_name = input('Enter the bloig title you want to write a post in: ')
